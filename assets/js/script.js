...
// Dirubah 
const pengirim = "Abang Hafidzz";
const nomorWa = "6285724299291" // awalan nomor 0 harus di awalin 62
const textWa = "Ah bisa aja kamu"
const pesan = `Pada akhirnya kita berdua menjadi dua orang penjahat: Kamu yang dengan hebatnya bisa mencuri hatiku, begitu juga aku yang berhasil mencuri hatimu,dan aku memang bukan google,tapi aku pastikan yang kamu cari pasti ada di aku`;
